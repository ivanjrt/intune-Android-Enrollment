...
<br/>OR:, Token enrollment option `afw#setup`: https://learn.microsoft.com/en-us/mem/intune/user-help/enroll-device-android-microsoft-intune-app#qr-code-enrollment  <br/>
